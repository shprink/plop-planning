...
var end = [19, 0];
var minIncr = 5;
var incr = function incr(time) {
    var hh = time[0],
        mm = time[1];
    var _a = [(mm + minIncr) % 60, (mm + minIncr) / 60 | 0],
        nmm = _a[0],
        h = _a[1];
    var nhh = hh + h;
    return [nhh, nmm];
};
var timeCompare = function timeCompare(t1, t2) {
    var h1 = t1[0],
        m1 = t1[1];
    var h2 = t2[0],
        m2 = t2[1];
...
var hours = "\n<header></header>\n<div class=\"content\">\n" + values.map(function (t) {
    return "<div class=\"time " + (t[0] % 2 === 0 ? 'even' : 'odd') + "\">" + displayTime(t) + "</div>";
}).join('\n') + "\n</div>";
var addHours = function addHours(elt) {
...
addHours();
// document.body.insertBefore(,elt);
...
//# sourceMappingURL=/src.485dc8ff.map